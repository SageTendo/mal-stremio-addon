...
MANIFEST_CACHE_DURATION = 60 * 60  # 1 hour
CATALOG_CACHE_ON_SUCCESS_DURATION = 300  # 5 minutes
CATALOG_CACHE_STALE_WHILE_REVALIDATE = 5  # 5 seconds
META_CACHE_ON_SUCCESS_DURATION = 7 * 24 * 60 * 60  # 7 days
STREAM_CACHE_ON_SUCCESS_DURATION = 3 * 60 * 60  # 3 hours
STREAM_CACHE_ON_FAIL_TO_FETCH_DURATION = 60  # 1 minute
...
CONTENT_SYNC_NO_UPDATE_DURATION = 24 * 60 * 60  # 1 day
